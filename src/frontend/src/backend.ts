...
export class Backend implements backendInterface {
    ...
    async addPdf(arg0: string, arg1: string, arg2: string, arg3: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addPdf(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deletePdf(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getPdf(arg0: string): Promise<PdfEntry> {
        if (this.processError) {
            try {
    ...
    async listPdfs(): Promise<Array<PdfEntry>> {
        if (this.processError) {
            try {
